...
dados_caixa_2023_df.loc[[0, 2, 5, 14],'Ativos'] = [
    'Total Geral Mensal', 
    'Total Renda Fixa',
    "Total Fii's",
    'Total Div Ações'
...
dados_caixa_2023_df.loc[~dados_caixa_2023_df.index.isin([0, 2, 5, 14]),'Ativos'] = dados_caixa_2023_df['Ativos'].str[5:]
...
# Concatene as novas linhas ao DataFrame original
